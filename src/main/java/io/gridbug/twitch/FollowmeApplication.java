...
public class FollowmeApplication implements CommandLineRunner {
	...
	private static final String authUrl = "https://api.twitch.tv/kraken/oauth2/authorize?response_type=token&client_id="+clientId+"&redirect_uri=http://localhost:8080/callback&scope=user_follows_edit";
